...
public class Login_email_daftar extends AppCompatActivity implements View.OnClickListener  {
    ...
    // Menampilkan daftar_layoutml
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.login_daftar_email);
        // Memberikan nilai
        ...
        disini.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Pindah dari class ini ke Login_email.java
                Intent i = new Intent(Login_email_daftar.this, Login_email.class);
                startActivity(i);
            }
        });
    ...
    public void registerUser(){
        ...
        if (email.isEmpty()) {
            daftaremail.setError("Login_email is required");
