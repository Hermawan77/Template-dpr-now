    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Pengaturan_Theme.setTheme(getApplication(), 0);
                //refresh activity
                recreate();
        ...
        t2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Pengaturan_Theme.setTheme(getApplication(), 1);
                recreate();
                Toast.makeText(Pengaturan.this, "Tema berhasil diubah", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Pengaturan_Theme.setTheme(getApplicationContext(), 2);
                recreate();
                Toast.makeText(Pengaturan.this, "Tema berhasil diubah", Toast.LENGTH_SHORT).show();
            }
        });
